...
local function common_postinit(inst)
	if inst._light ~= nil then
		inst._light.Light:SetColour(197 / 255, 128 / 255, 50 / 255)
		inst._light.Light:SetRadius(3.5)
	end
...
return MakeTorchFire("myth_dengfire", assets, nil, common_postinit, master_postinit)
