...
local COLOUR_ENVELOPE_NAME = "yama_firecolourenvelope_pulple"
local SCALE_ENVELOPE_NAME = "yama_firescaleenvelope_pulple"
...
local function InitEnvelope()
    ...
    EnvelopeManager:AddColourEnvelope(
        ...
        {
            { 0,    IntColour(210, 59, 221, 128) },
            { .49,  IntColour(210, 59, 221, 128) },
            { .5,   IntColour(210, 59, 221, 128) },
            { .51,  IntColour(210, 59, 221, 128) },
            { .75,  IntColour(210, 59, 221, 128) },
            { 1,    IntColour(210, 59, 221, 0) },
        }
    )
...
local function master_postinit(inst)
    inst.fx_offset = -110
    if inst._light then
        inst._light.Light:SetColour(210 / 255, 59 / 255, 221 / 255)
    end
end

return MakeTorchFire("yama_fire_purple", assets, nil, common_postinit, master_postinit)
