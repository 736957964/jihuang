...
local COLOUR_ENVELOPE_NAME = "yama_firecolourenvelope_green"
local SCALE_ENVELOPE_NAME = "yama_firescaleenvelope_green"
...
local function InitEnvelope()
    EnvelopeManager:AddColourEnvelope(
        ...
        {
            { 0,    IntColour(40, 246, 218, 128) },
            { .49,  IntColour(40, 246, 218, 128) },
            { .5,   IntColour(40, 246, 218, 128) },
            { .51,  IntColour(40, 246, 218, 128) },
            { .75,  IntColour(40, 246, 218, 128) },
            { 1,    IntColour(40, 246, 218, 0) },
        }
    )
...
local function master_postinit(inst)
    inst.fx_offset = -110
    if inst._light then
        inst._light.Light:SetColour(40 / 255, 246 / 255, 218 / 255)
    end
end

return MakeTorchFire("yama_fire_green", assets, nil, common_postinit, master_postinit)
