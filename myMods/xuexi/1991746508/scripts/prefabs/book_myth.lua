local assets =
{
    ...
    Asset("ANIM", "anim/bookinfo_myth_read.zip"),
    Asset("SOUND", "sound/together.fsb"),
    Asset("ATLAS", "images/inventoryimages/book_myth.xml"),
}
...
local function Spawn(inst)
    ...
    local fx = SpawnPrefab('bookinfo_myth')
    fx.Transform:SetPosition(pos:Get())
    fx:SpawnChild("halloween_firepuff_3")
...
local function fn()
    ...
    inst.components.inventoryitem.atlasname = "images/inventoryimages/book_myth.xml"

    inst:AddComponent("prototyper")
    inst.components.prototyper.onturnon = onturnon
    inst.components.prototyper.onturnoff = onturnoff
    inst.components.prototyper.onactivate = onactivate
    inst.components.prototyper.trees = TUNING.PROTOTYPER_TREES.MYTH_TECH
...
local function OnReadBook(inst, doer)
    doer:ShowPopUp(POPUPS.MYTHBOOKINFO, true)
end

local function infofn()
    local inst = CreateEntity()
    ...
    inst:AddComponent("inventoryitem")
    inst.components.inventoryitem.imagename = "book_myth"
    inst.components.inventoryitem.atlasname = "images/inventoryimages/book_myth.xml"
...
return Prefab("book_myth", fn, assets),
    Prefab("bookinfo_myth", infofn, assets)     
