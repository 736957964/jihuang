...
local function rock_ice_fn()
    ...
    inst._ismelt = net_bool(inst.GUID, "myth_rock_ghgice.ismelt", "stagedirty")
    inst._stage = net_tinybyte(inst.GUID, "myth_rock_ghgice.stage", "stagedirty")
...
return Prefab("myth_rock_ghgice", rock_ice_fn, rock_ice_assets, prefabs)
