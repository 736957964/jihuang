...
local function MakeWall(name, anims, isdoor, klaussackkeyid)
    ...
    local function fn()
        ...
        inst._pfpos = nil
        inst._ispathfinding = net_bool(inst.GUID, "_ismythpathfinding", "onispathfindingdirty")
        makeobstacle(inst)
...
local function MakeInvItem(name, placement, animdata, isdoor)
    local assets =
    {
		...
		Asset("ATLAS", "images/inventoryimages/myth_fence_item.xml"),
    }
    local item_prefabs =
    {
        placement,
    ...
    local function itemfn()
		...
		inst.components.inventoryitem.atlasname = "images/inventoryimages/myth_fence_item.xml"
...
return MakeWall("myth_fence", {wide="myth_fence",narrow="fence_thin"}, false),
    MakeInvItem("myth_fence_item", "myth_fence", "myth_fence", false),
    MakeWallPlacer("myth_fence_item_placer", "myth_fence", {wide="myth_fence", narrow="fence_thin"}, false)