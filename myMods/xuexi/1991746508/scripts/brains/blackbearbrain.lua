...
local function OpenHoneyPot(inst)
...
function BeargerBrain:OnStart()
    ...
    local root =
        PriorityNode(
        {
            ...
            DoAction(self.inst, OpenHoneyPot),
            ...
            WhileNode(function() return ShouldFollowFn(self.inst) end, "Follow To Base",
                PriorityNode(
                {
                    ...
                    Follow(self.inst, function() return  FindClosestPlayerToInst(self.inst, 30, true) end, 0, 15, 20, false)
                })),
