...
local function setrwms(yuyan)
    if yuyan == "chs" then
        STRINGS.MYTH_RENWUMIAOSHU = {
            ...
            NZ = {
                ...
                "莲藕之躯，喜好潮湿，可在潮湿度较高时能缓慢自愈伤口，亦可自损身躯制做莲花，可将莲花种在水池中。潮湿下武器不滑落。",
            ...
            YJ = {
                ...
                "待杨戬习得飞行术后，可变化雄鹰展翅，万里追踪，探开周围地图，并可选择一名队友直飞至其身边。亦可召唤傲天鹰，为队友运送补给。",
            ...
            YU = {
                ...
                "自带捣药杵，在神话栏使用技能【捣药】，最多同时捣2份药材，每个槽位的药材单独计算， 3秒后药材会消耗转化为药粉散开，药效会影响附近玩家。只有新鲜的素菜和其他珍贵药材可以入药。",
    ...
    elseif yuyan == "ja" then
        ...
        STRINGS.MYTH_RENWUMIAOSHU = {
            MK = {
                "足が速い。水が苦手で、湿気が嫌い。果物や野菜が好き。\n出家者は生臭物を食べない。「酒肉穿肠过」。生臭物を食べると収益が激減する。",
                "悟空が同じ目標に対して累積攻撃を6回行い、分身を触発し、目標の四角いところに悟空の分身を召喚して、分身は目標にそれぞれ1回ずつダメージを与えます。",
                "当年、悟空は「大闹天宫」して、天庭は山を焼き払った、「花果山」の生霊を塗炭させ、もし悟空が火をつけた植物や焦げた木に近づくと、景況に触れば、多くの精神的ダメージを受ける。",
                "Hボタンは「火眼金睛」を開けて、夜間視力を使って、霧を追い払って、急速に飽食度と理知値を消耗します。花粉や砂ぼこりでは使えません。",
                "「如意金箍棒」重さは三万六千斤。他の兵器は悟空には似合わず、半分の確率で手が離せます。悟空が「金箍棒」を装備している時、右ボタンスキル：「身外身法」は飽食度を消耗して瞬時に目標に移動し、その場に分身を残して恨みをそそる。",
                "「定海神针」は悟空の意のままになれる、神話の柵の中でこの技能を釈放することができて、「金箍棒」は大きくなって、そして天から降ってきて広い範囲の破壊になって、威力はきわめて大きくて、きっと注意して使います。",
                "素手の状態で自分に向かって右ボタンを押して、悟空は「障眼法」を使って、「土地庙」に変えて、近づいてくる愚かな敵を避けれる、ぜひ我慢して、声を出さないで。"
            },
            NZ = {
                "「哪吒」は「灵珠子」の転生で、天生の神童、妖魔を落とす。何でもできる、何でも怖くない。モンスターに対しては理性に減少する効果が半減します。",
                "蓮根の体は湿気が好きで、湿気が高い時に自分でゆっくりと傷を癒すことができます。また自分の体を壊して蓮の花を作れる、蓮の花を池に植えることができます。濡れた状態で武器は手を離せこともない。",
                "子供の心は神職の命と共にある。邪悪な生物を撃ったら理性値の奨励があります。もし非邪悪な生物を傷つけるなら、少しの理性値の処罰を受けます。",
                "この銃は持ち主を識別できる、燃えている目標や火属性の目標に対して2倍のダメージを与える。右ボタンの技能「三头六臂」は短くて無敵で、空に昇った後に急降下して3回の範囲の傷害をもたらします。",
                "はるかに目標に投げ、複数の目標の間で弾射し、「乾坤圏」が戻ったら手で受け止めます。「乾坤圏」が主を見分けがつく。他人のためには使えない。",
                "この綾は主人だけを保護しで、「哪吒」のために10回のダメージを完全に防ぐことができます。耐久性は蓮の花で修復できます。着用後も小幅な速度が向上します。"
            },
            WB = {
                "妖怪です。死後は死霊となり、祟りの効率が高い。骨組みだけを通して復活し、復活してピークの状態に戻る。軟膏と腺体は傷口を治療できない、血液袋の栄養補給効果がより良いです。影の生物の傷害は奥さんの飽食度を消耗するだけです。夫人は救いの心を作れません。",
                "夫人は専門の白骨の製作欄を持っていて、白骨の妖術を製造して使うことができて、例えば骨の武器、「阴森之心」、骨組み。骨の武器は骨片で修復できる。",
                "夫人は精血が好きです。悪夢の燃料と心臓を食べられます。生肉を食べたら罰がなく、しかも、より多くの収益があります。他の肉類の収益は低く、素類の収益はもっと低いです。暗影の心を食べるには奇効がある。",
                "大型生物を手で殺すと死体が残ります。左ボタンで直接に戦利品と確率を得て骨片を獲得します。右ボタンで死体は戦利品を溶かします。戦利品の量と同量の悪夢の燃料を受け取ることができます。悪夢の燃料を使って骨格を復活させることができます。白骨の随従は夫人が食べ物から得た収益を減らせます。",
                "空手の状態、右ボタンは自分で「化雾」の技能を使用して、少量の飽食度を使って、自身の近くで妖霧を召喚して、霧の中で行動するのは更に敏捷で、生物に発見されることはできなくて、そして憎しみの生物について急速に恨みをなくします。妖霧はしばらくその場に留まり、妖霧が消える後にまた再び召喚できます。",
                "Hボタンは顔を切り換えることができます。白骨の顔はもっと速くて、足取りが速くて、服と防具を装備できません。美人の顔の下には服と防具を装備できます。傷を受けると中立生物に同情を感じさせます。白骨になると周りを驚かせる。生物を積極的に攻撃したり、飢餓状態になったり、美人の顔を維持できなくなります。"
            },
            PG = {
                "天条に触れて、けなさせた、世の中に来た、豚に転生した、死后は救いの心や、猪屋に生まれ変わることを通じて生まれ変わるしかない。",
                "豚は「八戒」を同胞として、「八戒」からの食べ物を拒否しません。「八戒」は菜食で豚を買い入れることができます。「八戒」は危険を受けると助けになります。「八戒」は猪王に向かって口先がうまくと、より多くの金子を獲得する機会があります。",
                "「八戒」は農作業が得意で、素手でベリー、草、枝、作物を集めると早く完成できます。肥料をやると理知値の奨励を受ける。手が不器用で、作るのが苦手です。制作スピードがちょっと遅いです。",
                "お腹が空いているのが速くて、好き嫌いがなくて、いかなる食品を食べても理知値の罰がなくて、生臭物を食べて収益が低いです。空腹の時は攻撃力が弱まり、歩く力さえない。生存欄で草を消費し、「草垛」を作って、いつでもどこでも寝られます。",
                "お腹がいっぱいになるほど、皮が厚くなり、飽食度が高くなるほど防御が高まり、お腹がいっぱいになると体が大きくなります。",
                "「八戒」はいつも人の群れの中で一番見慣れない。「八戒」の攻撃は憎しみを優先的に惹きつけ、恨みから離れにくい。",
                "この熊手は「八戒」によって農作業に使われ、右ボタンの空き地は鋤で耕し、掘った土の山は作物を植えることができます。熊手を持って、生物について右ボタンを押す、生物に数秒の間ブロックができます。ブロックは大量の傷害を相殺することができます。残りのダメージは「八戒」の飽食度に変換されて消耗します。"
            },
            YJ = {
                "「天眼」闇を見抜き、影の力の本質を見抜き、影の力を前にして極度の理知を保つことができる。「杨戬」影の力を排斥して、魔法の道具を作ることを潔しとしない。",
                "右ボタンの「哮天犬」はその場で待機して、素手の右ボタンは自分で口笛を吹いて、「哮天犬」を呼びます。「哮天犬」は自発的にウサギを狩猟できて、「杨戬」からあげた物品も探せます。満月の時に月の石を与えたら、変身できます。",
                "「三尖刀」は雷の属性を持つ武器で、濡れたターゲットには追加の雷電ダメージを与えます。右ボタンの技能「驱雷掣电」は稲妻を引きつけます。もし稲妻が「三尖刀」に当たると雷の効果が付加できます。雷の効果がある時に、同じ目標に累積攻撃の回数は6回になったら、「天雷」を相手に撃てることができます。",
                "Hボタンは「天眼」を使い、夜間視力、霧を追い払い、暗闇を洞察し、飽食度を急速に消耗し続けます。砂ぼこりの時は使えません。",
                "「杨戬」が飛行術を習得したら、雄鷹の羽ばたきを変えて、万里の追跡をできて、周囲の地図を探せます。そして、チームメートを選んで直接に彼のそばに飛ぶことができます。孤天鷹を召喚できて、チームメイトに補給を送ります。",
                "雷の効果の下の「三尖刀」右ボタンの技能「驱雷掣电」は選択したエリアに向かって瞬間的に移動して突撃し、複数の雷を誘発して近くの目標に割り、ターゲットを感電状態にして、受けるダメージが増加します。"
            },
            YU = {
                "ウサギのために穴を作ることもできますし、ウサギの穴から何かを収穫することもできます。マウスの右ボタンは自分で地下に逃げ込むことができます。地下では、夜視に似た効果があり、攻撃や他の生物からの憎しみを受けないが、満腹度や理知値をより速く消費し、空腹、「紫金葫芦」や地震技能などは技能の効果を断つことがある。",
                "薬棒を持っていて、攻撃距離が短いです。神話欄で技能を使って、薬草を2つ置くことができます。2つの薬草は単独で計算します。3秒後、薬草は消耗します。薬粉に変えて散布します。薬効は近くのプレーヤーに影響します。",
                "ウサギです。ベジタリアンです。暗があまり怖くない、ウサギ人との関係はとても友好的です。ウサギは彼女を避けることはやりません。彼女はウサギを直接拾ってもいいです。彼女はウサギを傷つけることはありません。物品欄やリュックサックの中にウサギがいる時、彼女はずっと理知を回復できます。近くにウサギが死んだら彼女を悲しませます。彼女はニンジンに関する食べ物が好きです",
                "神話欄で花弁を一つ使って月蛾を召喚して、月蛾は「广寒宫」の方向に飛んでいきます。捕獲できない。",
                "月島では啓蒙値の負の効果はなく、月島地皮でより速い移動速度が得られます。「广寒宫」に入ると時間の制限を受けず、「嫦娥」に追い立てられません。「嫦娥」の好感度を上げる過程で、月餅を獲得する確率が倍になり、「嫦娥」とのふれあいの時に好感度のアップはより速くなります。"
            },
            YA = {
                "黑白无常虽双生一体，属性却各不相同，可以主动切换在人世的形象。",
                "作为阴司正神，没有生命值，只有魂魄值。黑白无常不会死亡，当两位无常都魂飞魄散时变成一缕漂泊的魂魄，一段时间后再次临世。",
