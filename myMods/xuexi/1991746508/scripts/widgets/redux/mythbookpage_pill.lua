...
function MythbookPagePill:CreateRecipeBook()
	...
	self.spinner_root:SetPosition(-140, grid_h/2-5+20)

	self.details_root:AddChild(self:PopulateRecipeDetailPanel(self.all_recipes[ (MYTH_BOOKINFO_PAGES.selected ~= nil and MYTH_BOOKINFO_PAGES.selected[self.category] or 1) ]))
