...
--                    inst.SoundEmitter:PlaySound("fa/skeleton/skel_atk")
 ...
 --               inst.SoundEmitter:PlaySound("fa/skeleton/skel_atk")
        ...
        timeline=
        {	
			TimeEvent(4*FRAMES, function(inst) inst.SoundEmitter:PlaySound("dontstarve/wilson/attack_nightsword") end),
	...
	State{
        ...
        onexit = function(inst)
			...
			inst.AnimState:SetBuild("crashbandi")
        end,
...
return StateGraph("shadowboss", states, events, "idle", actionhandlers)
