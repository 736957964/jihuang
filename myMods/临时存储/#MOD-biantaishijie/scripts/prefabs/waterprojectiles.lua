...
local function common_fn(bank, build, anim, tag, isinventoryitem)
	...
	----inst.AnimState:SetMultColour(math.random(1,255)/255,math.random(1,255)/255,math.random(1,255)/255)
...
local function snowball_fn()
    ...
    inst.AnimState:SetMultColour(math.random(1,255)/255,math.random(1,255)/255,math.random(1,255)/255,0)
    inst.persists = false
