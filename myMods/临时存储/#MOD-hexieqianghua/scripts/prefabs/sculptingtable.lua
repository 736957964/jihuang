...
local function ongivenitem(inst, giver, item)
	if item:HasTag("sketch") or     item:HasTag("chesspiece_dragonfly_builder")   or  item:HasTag("chesspiece_moosegoose_builder")or  item:HasTag("chesspiece_bearger_builder")or  item:HasTag("chesspiece_deerclops_builder") then
		
		if item:HasTag("sketch")then
			
			AddSketch(inst, item)
		elseif item:HasTag("chesspiece_dragonfly_builder") then
			item = SpawnPrefab("dragonfly")
			
		elseif item:HasTag("chesspiece_moosegoose_builder") then
			item = SpawnPrefab("moose")
			
		elseif item:HasTag("chesspiece_bearger_builder") then
			item = SpawnPrefab("bearger")
			
			
		elseif item:HasTag("chesspiece_deerclops_builder") then
			item = SpawnPrefab("deerclops")
		end
	else
