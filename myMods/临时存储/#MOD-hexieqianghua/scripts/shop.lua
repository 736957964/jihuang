...
local function getselllist(oldselllist,level)--从上面的列表中获取包含与商店等级相关数量的随机的物品出售列表
	...
	for i = 1,num do
		...
		goods.price = goods.price * (math.random(90 ,140)/100)--基础价格的0.9~1.4倍间取随机数保证价格的随机波动
...
local function buy(item,money,buyer,shop)--item出售物品，money金元宝+余额
	...
	if money >= price then
		...
		if shop.sellrecord[buyer.userid] >= 3 and buyer.components.talker then
...
local function OnStartDay(inst)--12级以后可以在附近生成金元宝
	if math.random() < 0.05 then--5%可以生成一个金元宝
		inst:DoTaskInTime(GetRandomMinMax(3, 5), TrySpawnMoney)
	end
end

local getmoneylist = {--物品换钱的列表(辛苦控制台了~)
{prefab = "mole",name = "鼹鼠",value = 0.07 },
{prefab = "turf_road",name = "卵石路",value = 0.025 },
{prefab = "halloweencandy_7",name = "葡萄干",value = 0.01 },
{prefab = "halloweencandy_9",name = "果冻虫",value = 0.01 },
{prefab = "turf_savanna",name = "热带草原地皮",value = 0.015 },
{prefab = "minifan",name = "回旋扇",value = 0.02 },
{prefab = "hambat",name = "火腿棍",value = 0.08 },
{prefab = "dug_berrybush_juicy",name = "多汁浆果丛",value = 0.03 },
{prefab = "dug_marsh_bush",name = "荆棘丛",value = 0.015 },
{prefab = "drumstick_cooked",name = "炸鸡腿",value = 0.022 },
{prefab = "gunpowder",name = "火药",value = 0.08 },
{prefab = "humanmeat",name = "人肉",value = 0.05 },
{prefab = "dragontailhat",name = "幸运野兽尾巴",value = 0.10 },
{prefab = "shroom_skin",name = "魔蛤皮",value = 1.00 },
{prefab = "brush",name = "洗刷",value = 0.10 },
{prefab = "honeyham",name = "蜜汁火腿",value = 0.09 },
{prefab = "amulet",name = "重生护符",value = 0.20 },
{prefab = "stinger",name = "蛰刺",value = 0.01 },
{prefab = "pumpkin",name = "大南瓜",value = 0.06 },
{prefab = "wormlight_lesser",name = "微光浆果",value = 0.04 },
{prefab = "beargervest",name = "熊皮背心",value = 0.80 },
{prefab = "waterballoon",name = "水球",value = 0.06 },
{prefab = "trinket_33",name = "蜘蛛戒指",value = 0.02 },
{prefab = "ice",name = "冰",value = 0.03 },
{prefab = "honey",name = "蜂蜜",value = 0.02 },
{prefab = "molehat",name = "鼹鼠帽",value = 0.08 },
{prefab = "abigail_flower",name = "阿比盖尔之花",value = 0.16 },
{prefab = "trunk_summer",name = "象鼻",value = 0.16 },
{prefab = "slurtlehat",name = "蜗牛帽",value = 0.20 },
{prefab = "healingsalve",name = "治疗药膏",value = 0.08 },
{prefab = "lightbulb",name = "荧光果",value = 0.008 },
{prefab = "heatrock",name = "热能石",value = 0.10 },
{prefab = "lightninggoathorn",name = "伏特山羊角",value = 0.50 },
{prefab = "trinket_29",name = "黑色棋子——车",value = 0.03 },
{prefab = "krampus_sack",name = "坎普斯背包",value = 2.50 },
{prefab = "earmuffshat",name = "小兔耳罩",value = 0.20 },
{prefab = "cutstone",name = "石砖",value = 0.03 },
{prefab = "eel_cooked",name = "烤鳗鱼",value = 0.08 },
{prefab = "pickaxe",name = "鹤嘴锄",value = 0.06 },
{prefab = "lavae_egg_cracked",name = "岩浆蛋",value = 0.50 },
{prefab = "gift",name = "礼物",value = 0.10 },
{prefab = "powcake",name = "芝士蛋糕",value = 0.06 },
{prefab = "beefalowool",name = "野牛的毛",value = 0.015 },
{prefab = "tallbirdegg_cracked",name = "孵化中的高脚鸟蛋",value = 0.12 },
{prefab = "trunk_cooked",name = "无尾象鼻",value = 0.18 },
{prefab = "book_sleep",name = "睡前故事",value = 0.18 },
{prefab = "trinket_15",name = "白色主教",value = 0.03 },
{prefab = "waxpaper",name = "蜡纸",value = 0.10 },
{prefab = "armorslurper",name = "饥饿腰带",value = 0.30 },	
{prefab = "pomegranate_cooked",name = "切片熟石榴",value = 0.08 },
{prefab = "bee",name = "蜜蜂",value = 0.04 },
{prefab = "tentaclespots",name = "触手皮",value = 0.10 },
{prefab = "rabbit",name = "兔子",value = 0.04 },
{prefab = "smallmeat_dried",name = "小风干肉",value = 0.08 },
{prefab = "yellowamulet",name = "魔光护符",value = 0.40 },
{prefab = "minisign_drawn",name = "小型标志",value = 0.04 },
{prefab = "bugnet",name = "捕虫网",value = 0.05 },
{prefab = "catcoonhat",name = "浣熊猫帽子",value = 0.07 },
{prefab = "bernie_inactive",name = "伯尼",value = 0.13 },
{prefab = "compass",name = "指南针",value = 0.02 },
{prefab = "goatmilk",name = "羊奶",value = 0.20 },
{prefab = "mosquitosack",name = "蚊子血囊",value = 0.06 },
{prefab = "rope",name = "绳子",value = 0.02 },
{prefab = "hivehat",name = "蜂后头冠",value = 0.80 },
{prefab = "petals_evil",name = "恶魔花瓣",value = 0.05 },
{prefab = "beehat",name = "养蜂帽",value = 0.08 },
{prefab = "turf_fungus_red",name = "菌类地皮",value = 0.015 },
{prefab = "minisign_item",name = "小型标志",value = 0.02 },
{prefab = "umbrella",name = "雨伞",value = 0.08 },
{prefab = "watermelonhat",name = "西瓜帽",value = 0.08 },
{prefab = "plantmeat",name = "食人花肉",value = 0.05 },
{prefab = "grass_umbrella",name = "漂亮花伞",value = 0.06 },
{prefab = "wall_stone_item",name = "石墙",value = 0.01 },
{prefab = "greenmooneye",name = "绿色月棱镜",value = 1.20 },
{prefab = "cutlichen",name = "苔藓",value = 0.015 },
{prefab = "book_tentacles",name = "在触手之上",value = 0.18 },
{prefab = "turf_dragonfly",name = "鳞状地板",value = 0.02 },
{prefab = "opalpreciousgem",name = "彩虹宝石",value = 0.70 },
{prefab = "feather_canary",name = "橙黄羽毛",value = 0.01 },
{prefab = "froglegs",name = "蛙腿",value = 0.03 },
{prefab = "cutgrass",name = "干草",value = 0.008 },
{prefab = "rainhat",name = "防雨帽",value = 0.07 },
{prefab = "nightmarefuel",name = "噩梦燃料",value = 0.05 },
{prefab = "yellowgem",name = "黄色宝石",value = 0.30 },
{prefab = "balloons_empty",name = "韦斯的气球",value = 0.30 },
{prefab = "featherfan",name = "羽毛扇",value = 0.40 },
{prefab = "trinket_9",name = "不搭的纽扣",value = 0.02 },
{prefab = "beemine",name = "蜜蜂地雷",value = 0.03 },
{prefab = "firecrackers",name = "红色爆竹",value = 0.10 },
{prefab = "turf_forest",name = "森林地皮",value = 0.01 },
{prefab = "dragonfruit",name = "火龙果",value = 0.10 },
{prefab = "cactus_meat",name = "仙人掌肉",value = 0.04 },
{prefab = "redgem",name = "红色宝石",value = 0.25 },
{prefab = "halloweencandy_6",name = "葡萄干",value = 0.02 },
{prefab = "raincoat",name = "雨衣",value = 0.10 },
{prefab = "glommerflower",name = "咕噜咪之花",value = 0.12 },
{prefab = "pumpkin_seeds",name = "南瓜种子",value = 0.012 },	
{prefab = "seeds_cooked",name = "烤种子",value = 0.01 },
{prefab = "thurible",name = "阴影香炉",value = 0.40 },
{prefab = "perdfan",name = "幸运风扇",value = 0.40 },
{prefab = "nightstick",name = "晨星",value = 0.20 },
{prefab = "trinket_7",name = "剑玉",value = 0.02 },
{prefab = "green_cap_cooked",name = "烤绿帽子蘑菇",value = 0.025 },
{prefab = "fertilizer",name = "堆肥桶",value = 0.06 },
{prefab = "lureplantbulb",name = "食人花种子",value = 0.08 },
{prefab = "robin",name = "红雀",value = 0.10 },
{prefab = "lantern",name = "提灯",value = 0.06 },
{prefab = "boneshard",name = "骨头碎片",value = 0.022 },
{prefab = "bedroll_straw",name = "草席",value = 0.045 },
{prefab = "reviver",name = "复活之心",value = 0.033 },
{prefab = "guacamole",name = "鼹梨沙拉酱",value = 0.06 },
{prefab = "halloweencandy_11",name = "巧克力猪",value = 0.02 },
{prefab = "trinket_34",name = "猴爪",value = 0.02 },
{prefab = "chesspiece_pawn",name = "兵卒模型",value = 0.02 },
{prefab = "bonestew",name = "炖肉汤",value = 0.08 },
{prefab = "charcoal",name = "木炭",value = 0.01 },
{prefab = "atrium_key",name = "古代钥匙",value = 0.50 },
{prefab = "orangestaff",name = "瞬移魔杖",value = 0.60 },
{prefab = "pumpkin_lantern",name = "南瓜灯",value = 0.06 },
{prefab = "winter_food9",name = "天堂蛋酒",value = 0.01 },
{prefab = "winter_food7",name = "苹果酒",value = 0.01 },
{prefab = "lucy",name = "露西斧",value = 0.20 },
{prefab = "featherpencil",name = "羽毛笔",value = 0.06 },
{prefab = "eggplant_seeds",name = "茄子种子",value = 0.012 },
{prefab = "bandage",name = "蜂蜜药膏",value = 0.12 },
{prefab = "winter_food6",name = "李子布丁",value = 0.01 },
{prefab = "blue_cap",name = "蓝帽子蘑菇",value = 0.02 },
{prefab = "winter_food5",name = "巧克力木头蛋糕",value = 0.01 },
{prefab = "winter_food4",name = "永恒水果蛋糕",value = 0.01 },
{prefab = "winter_food3",name = "拐杖糖",value = 0.01 },
{prefab = "mandrakesoup",name = "曼德拉草汤",value = 0.01 },
{prefab = "winter_food2",name = "糖屑曲奇饼",value = 0.01 },
{prefab = "winter_food1",name = "姜饼人曲奇饼",value = 0.01 },
{prefab = "deserthat",name = "沙漠目镜",value = 0.04 },
{prefab = "fruitmedley",name = "水果圣代",value = 0.01 },
{prefab = "spiderhat",name = "蜘蛛帽",value = 0.10 },
{prefab = "canary",name = "金丝雀",value = 0.10 },
{prefab = "sketch",name = "{item} 素描",value = 0.10 },
{prefab = "chesspiece_rook",name = "车模型",value = 0.02 },
{prefab = "trunkvest_summer",name = "保暖小背心",value = 0.06 },
{prefab = "fossil_piece",name = "化石碎片",value = 0.20 },
{prefab = "feather_robin_winter",name = "碧空雪羽",value = 0.01 },
{prefab = "blowdart_yellow",name = "电箭",value = 0.03 },
{prefab = "watermelon_seeds",name = "西瓜种子",value = 0.015 },
{prefab = "transistor",name = "电子元件",value = 0.025 },
{prefab = "turf_checkerfloor",name = "棋盘地板",value = 0.015 },
{prefab = "halloweencandy_10",name = "触须棒糖",value = 0.01 },	
{prefab = "reflectivevest",name = "清凉夏装",value = 0.04 },
{prefab = "orangeamulet",name = "懒人强盗",value = 0.40 },
{prefab = "acorn_cooked",name = "烤桦木果",value = 0.03 },
{prefab = "trinket_11",name = "机器人玩偶",value = 0.01 },
{prefab = "goggleshat",name = "时髦目镜",value = 0.05 },
{prefab = "turf_sinkhole",name = "粘泥地皮",value = 0.01 },
{prefab = "whip",name = "三尾猫鞭",value = 0.08 },
{prefab = "green_cap",name = "绿帽子蘑菇",value = 0.02 },

{prefab = "trinket_16",name = "黑色主教",value = 0.01 },
{prefab = "trailmix",name = "什锦干果",value = 0.01 },
{prefab = "turf_rocky",name = "岩石地皮",value = 0.01 },
{prefab = "dug_sapling",name = "树苗",value = 0.02 },
{prefab = "turf_woodfloor",name = "木地板",value = 0.015 },
{prefab = "berries_cooked",name = "烤浆果",value = 0.01 },
...
{prefab = "trinket_17",name = "掰弯的叉勺",value = 0.01 },
{prefab = "blueprint",name = "蓝图",value = 0.03 },
{prefab = "wall_ruins_item",name = "图勒墙",value = 0.015 },
{prefab = "wall_moonrock_item",name = "月亮石墙",value = 0.03 },
{prefab = "fishingrod",name = "钓竿",value = 0.05 },
{prefab = "wall_hay_item",name = "干草墙",value = 0.01 },
{prefab = "piggyback",name = "猪皮包",value = 0.20 },
{prefab = "berries_juicy",name = "多汁浆果",value = 0.01 },
{prefab = "lavae_cocoon",name = "冷冻幼虫",value = 0.30 },
{prefab = "bushhat",name = "灌木帽",value = 0.08 },
{prefab = "lavae_tooth",name = "岩浆牙",value = 0.20 },
{prefab = "trinket_12",name = "干瘪的触手",value = 0.01 },
{prefab = "multitool_axe_pickaxe",name = "镐斧",value = 0.16 },
{prefab = "antliontrinket",name = "沙滩玩具",value = 0.02 },
{prefab = "durian_seeds",name = "榴莲种子",value = 0.01 },
{prefab = "durian_cooked",name = "巨臭榴莲",value = 0.02 },
{prefab = "cactus_meat_cooked",name = "烤仙人掌肉",value = 0.036 },
{prefab = "succulent_picked",name = "多肉植物",value = 0.02 },
{prefab = "redmooneye",name = "红色月石",value = 0.30 },
{prefab = "berries_juicy_cooked",name = "多汁烤浆果",value = 0.01 },
{prefab = "yellowstaff",name = "唤星者法杖",value = 0.40 },
{prefab = "trinket_8",name = "硬化橡胶塞",value = 0.02 },
{prefab = "armorruins",name = "图勒护甲",value = 0.60 },
{prefab = "wall_wood_item",name = "木墙",value = 0.01 },
{prefab = "tophat",name = "绅士高帽",value = 0.06 },
{prefab = "beefalohat",name = "牛角帽",value = 0.08 },
{prefab = "redlantern",name = "红灯笼",value = 0.20 },
{prefab = "watermelon",name = "西瓜",value = 0.02 },
{prefab = "carrot_seeds",name = "胡萝卜种子",value = 0.01 },
{prefab = "carrot_cooked",name = "烤胡萝卜",value = 0.02 },	
{prefab = "carrot",name = "胡萝卜",value = 0.02 },
{prefab = "turf_carpetfloor",name = "地毯地板",value = 0.015 },
{prefab = "cookedsmallmeat",name = "烤小肉",value = 0.02 },
{prefab = "boomerang",name = "回旋镖",value = 0.07 },
{prefab = "dragonfruit_cooked",name = "火龙果切片",value = 0.08 },
{prefab = "pomegranate",name = "石榴",value = 0.02 },
{prefab = "cave_banana_cooked",name = "烤香蕉",value = 0.022 },
{prefab = "cave_banana",name = "洞穴香蕉",value = 0.018 },
{prefab = "corn_seeds",name = "玉米种子",value = 0.01 },
{prefab = "corn_cooked",name = "爆米花",value = 0.02 },
{prefab = "minotaurhorn",name = "守护者之角",value = 10.00 },
{prefab = "kabobs",name = "肉串",value = 0.04 },
{prefab = "ratatouille",name = "蔬菜大杂烩",value = 0.04 },
{prefab = "turf_fungus_green",name = "菌类地皮",value = 0.01 },
{prefab = "turf_grass",name = "牧草地皮",value = 0.01 },
{prefab = "waxwelljournal",name = "暗影法典",value = 0.20 },
{prefab = "fireflies",name = "萤火虫",value = 0.06 },
{prefab = "red_mushroomhat",name = "红色乐趣帽子蘑菇",value = 0.12 },
{prefab = "turf_mud",name = "泥泞地皮",value = 0.01 },
{prefab = "turf_underrock",name = "岩洞地皮",value = 0.01 },
{prefab = "walrus_tusk",name = "海象牙",value = 0.30 },
{prefab = "trunkvest_winter",name = "寒冬背心",value = 0.09 },
{prefab = "trunk_winter",name = "冬象鼻",value = 0.12 },
{prefab = "sewing_kit",name = "针线包",value = 0.08 },
{prefab = "cookedmonstermeat",name = "烤怪物肉",value = 0.005 },
{prefab = "trinket_37",name = "折断的棍子",value = 0.01 },
{prefab = "monstermeat",name = "怪物肉",value = 0.003 },
{prefab = "armorgrass",name = "草甲",value = 0.06 },
{prefab = "minerhat",name = "矿工帽",value = 0.09 },
{prefab = "halloweencandy_1",name = "苹果糖",value = 0.01 },
{prefab = "trinket_35",name = "空的万能药",value = 0.02 },
{prefab = "blowdart_pipe",name = "吹箭",value = 0.03 },
{prefab = "trinket_31",name = "黑色棋子——骑士",value = 0.02 },
{prefab = "deerclops_eyeball",name = "鹿角怪眼球",value = 2.40 },
{prefab = "trinket_27",name = "铁线衣架",value = 0.02 },
{prefab = "purplemooneye",name = "紫色月石",value = 0.35 },
{prefab = "trinket_25",name = "空气污浊剂",value = 0.02 },
{prefab = "trinket_23",name = "鞋拔子",value = 0.02 },
{prefab = "trinket_22",name = "磨损纱线",value = 0.02 },
{prefab = "trinket_21",name = "残破搅拌器",value = 0.02 },
{prefab = "trinket_18",name = "玩家木马",value = 0.02 },
{prefab = "orangegem",name = "橙色宝石",value = 0.30 },
{prefab = "trinket_14",name = "破裂茶杯",value = 0.02 },
{prefab = "ruinshat",name = "图勒王冠",value = 0.40 },
{prefab = "torch",name = "火炬",value = 0.03 },
{prefab = "wormlight",name = "发光蓝莓",value = 0.12 },
{prefab = "trinket_6",name = "烂电线",value = 0.02 },
{prefab = "trinket_5",name = "迷你火箭",value = 0.02 },
{prefab = "trinket_2",name = "假货卡祖笛",value = 0.02 },	
{prefab = "halloweencandy_8",name = "幽灵糖",value = 0.01 },
{prefab = "durian",name = "榴莲",value = 0.015 },
{prefab = "spidereggsack",name = "蜘蛛卵",value = 0.08 },
{prefab = "firestaff",name = "火焰法杖",value = 0.12 },
{prefab = "blowdart_sleep",name = "催眠吹箭",value = 0.03 },
{prefab = "lavae_egg",name = "岩浆蛋",value = 0.30 },
{prefab = "beardhair",name = "胡子",value = 0.04 },
{prefab = "watermelon_cooked",name = "烤西瓜",value = 0.025 },
{prefab = "trinket_13",name = "地精",value = 0.02 },
{prefab = "boards",name = "木板",value = 0.02 },
{prefab = "thulecite_pieces",name = "图勒碎片",value = 0.02 },
{prefab = "thulecite",name = "图勒信物",value = 0.13 },
{prefab = "watermelonicle",name = "西瓜冰棍",value = 0.08 },
{prefab = "foliage",name = "蕨叶",value = 0.015 },
{prefab = "staff_tornado",name = "天气棒",value = 0.12 },
{prefab = "teleportato_potato",name = "金属球狀零件",value = 0.20 },
...
{prefab = "onemanband",name = "独奏乐器",value = 0.12 },
{prefab = "tallbirdegg",name = "高脚鸟蛋",value = 0.08 },
{prefab = "sweatervest",name = "格子背心",value = 0.06 },
{prefab = "steelwool",name = "钢绒",value = 0.10 },
{prefab = "nitre",name = "硝石",value = 0.03 },
{prefab = "honeynuggets",name = "蜜汁卤肉",value = 0.06 },
{prefab = "blueamulet",name = "寒冰护符",value = 0.16 },
{prefab = "turf_deciduous",name = "桦树地皮",value = 0.01 },
{prefab = "spore_tall",name = "蓝色孢子",value = 0.02 },
{prefab = "butterflywings",name = "蝴蝶翅膀",value = 0.025 },
{prefab = "saddle_basic",name = "普通牛鞍",value = 0.10 },
{prefab = "saddle_race",name = "薄弱牛鞍",value = 0.40 },
{prefab = "eggplant",name = "茄子",value = 0.02 },
{prefab = "armordragonfly",name = "鳞甲",value = 0.16 },
{prefab = "goldenpickaxe",name = "黄金鹤嘴锄",value = 0.06 },
{prefab = "icehat",name = "冰块帽",value = 0.08 },
{prefab = "spear",name = "长矛",value = 0.04 },
{prefab = "feather_robin",name = "绯色羽毛",value = 0.01 },
{prefab = "meatballs",name = "肉丸",value = 0.06 },
{prefab = "bird_egg",name = "蛋",value = 0.008 },
{prefab = "halloweencandy_5",name = "卡通糖果",value = 0.01 },
{prefab = "glommerwings",name = "咕嚕咪翅膀",value = 0.10 },
{prefab = "crow",name = "乌鸦",value = 0.10 },
{prefab = "trinket_32",name = "方晶锆石球",value = 0.02 },
{prefab = "butter",name = "黄油",value = 0.30 },
{prefab = "opalstaff",name = "访月者的手杖",value = 0.30 },
{prefab = "telestaff",name = "传送魔杖",value = 0.28 },
{prefab = "icestaff",name = "冰魔杖",value = 0.24 },
{prefab = "plantmeat_cooked",name = "烤食人花肉",value = 0.03 },	
{prefab = "spoiled_food",name = "腐烂食物",value = 0.01 },
{prefab = "spore_medium",name = "红色孢子",value = 0.02 },
{prefab = "winter_food8",name = "热可可",value = 0.01 },
{prefab = "spidergland",name = "蜘蛛腺",value = 0.01 },
{prefab = "candybag",name = "糖袋",value = 0.03 },
{prefab = "feather_crow",name = "乌鸦羽毛",value = 0.01 },
{prefab = "jammypreserves",name = "满满的果酱",value = 0.06 },
{prefab = "bluemooneye",name = "蓝色月棱镜",value = 0.30 },
{prefab = "goose_feather",name = "羽绒",value = 0.01 },
{prefab = "tallbirdegg_cooked",name = "煎高脚鸟蛋",value = 0.08 },
{prefab = "slurtleslime",name = "尖壳蜗牛黏液",value = 0.12 },
{prefab = "slurper_pelt",name = "啜食兽毛皮",value = 0.20 },
{prefab = "flint",name = "燧石",value = 0.01 },
{prefab = "silk",name = "蜘蛛丝",value = 0.008 },
{prefab = "meat",name = "肉",value = 0.03 },
{prefab = "pomegranate_seeds",name = "石榴种子",value = 0.01 },
{prefab = "trinket_28",name = "白色棋子——车",value = 0.02 },
{prefab = "houndstooth",name = "犬牙",value = 0.01 },
{prefab = "fence_item",name = "木栅栏",value = 0.01 },
{prefab = "armor_sanity",name = "暗影护甲",value = 0.40 },
{prefab = "trinket_4",name = "地精玩偶",value = 0.02 },
{prefab = "humanmeat_cooked",name = "煮熟的人肉",value = 0.10 },
{prefab = "seeds",name = "种子",value = 0.01 },
{prefab = "green_mushroomhat",name = "绿色乐趣帽子蘑菇",value = 0.10 },
{prefab = "halloweencandy_3",name = "似糖非糖玉米",value = 0.01 },
{prefab = "halloweencandy_2",name = "玉米糖",value = 0.01 },
{prefab = "pumpkin_cooked",name = "烤南瓜",value = 0.05 },
{prefab = "book_brimstone",name = "末日将至！",value = 0.20 },
{prefab = "fishtacos",name = "鱼肉玉米卷",value = 0.04 },
{prefab = "trinket_30",name = "白色棋子——骑士",value = 0.02 },
{prefab = "winterhat",name = "冬帽",value = 0.07 },
{prefab = "dug_grass",name = "草丛",value = 0.02 },
{prefab = "moonrockcrater",name = "坑洼的月石",value = 0.20 },
{prefab = "saddlehorn",name = "取鞍器",value = 0.12 },
{prefab = "saddle_war",name = "战争牛鞍",value = 0.30 },
{prefab = "ruins_bat",name = "图勒棒",value = 0.25 },
{prefab = "slurtle_shellpieces",name = "甲壳碎片",value = 0.06 },
{prefab = "book_birds",name = "世界鸟类图鉴",value = 0.20 },
{prefab = "butterfly",name = "蝴蝶",value = 0.04 },
{prefab = "purplegem",name = "紫色宝石",value = 0.23 },
{prefab = "cookedmeat",name = "烤大肉",value = 0.03 },
{prefab = "yellowmooneye",name = "黄色月棱镜",value = 0.40 },
{prefab = "froglegs_cooked",name = "烤蛙腿",value = 0.02 },
{prefab = "redpouch",name = "红包",value = 0.80 },
{prefab = "wetpouch",name = "皱皱的袋子",value = 0.02 },
{prefab = "razor",name = "剃刀",value = 0.03 },
{prefab = "bundle",name = "捆绑成束的补给",value = 0.08 },
{prefab = "fishsticks",name = "炸鱼排",value = 0.06 },	
{prefab = "shadowheart",name = "暗影之心",value = 0.30 },
--{prefab = "papyrus",name = "莎草纸",value = 0.06 },
{prefab = "chesspiece_bishop",name = "主教模型",value = 0.02 },
{prefab = "flowersalad",name = "花沙拉",value = 0.07 },
{prefab = "turf_fungus",name = "菌类地皮",value = 0.01 },
{prefab = "chesspiece_formal",name = "国王模型",value = 0.02 },
{prefab = "perogies",name = "波兰水饺",value = 0.08 },
{prefab = "taffy",name = "太妃糖",value = 0.06 },
{prefab = "unagi",name = "鳗鱼料理",value = 0.08 },
{prefab = "icecream",name = "冰淇淋",value = 0.10 },
{prefab = "walrushat",name = "苏格兰帽",value = 0.08 },
{prefab = "armormarble",name = "大理石甲",value = 0.12 },
{prefab = "baconeggs",name = "培根煎蛋",value = 0.08 },
{prefab = "red_cap",name = "小红帽蘑菇",value = 0.02 },
{prefab = "frogglebunwich",name = "蛙腿三明治",value = 0.04 },
{prefab = "hotchili",name = "辣椒炖肉",value = 0.04 },
{prefab = "monsterlasagna",name = "怪物千层饼",value = 0.010 },
{prefab = "trinket_24",name = "幸运猫罐",value = 0.02 },
{prefab = "humanmeat_dried",name = "人肉干",value = 0.12 },
{prefab = "waffles",name = "华夫饼",value = 0.40 },
{prefab = "jellybean",name = "糖豆",value = 0.20 },
{prefab = "shovel",name = "铲子",value = 0.06 },
{prefab = "bird_egg_cooked",name = "煎蛋",value = 0.010 },
{prefab = "smallmeat",name = "小肉",value = 0.02 },
{prefab = "poop",name = "粪便",value = 0.025 },
{prefab = "robin_winter",name = "雪雀",value = 0.10 },
{prefab = "acorn",name = "桦木果",value = 0.03 },
{prefab = "greenamulet",name = "建造护符",value = 0.40 },
{prefab = "dug_berrybush",name = "浆果丛",value = 0.025 },
{prefab = "pitchfork",name = "干草叉",value = 0.05 },
{prefab = "twiggy_nut",name = "多枝树果",value = 0.03 },
{prefab = "beeswax",name = "蜂蜡",value = 0.06 },
{prefab = "pinecone",name = "榛果",value = 0.02 },
{prefab = "monstermeat_dried",name = "怪物肉干",value = 0.008 },
{prefab = "pigskin",name = "猪人皮",value = 0.04 },
{prefab = "eyeturret_item",name = "眼球镭射塔",value = 20.00 },
{prefab = "dragonheadhat",name = "幸运野兽头部",value = 0.20 },
{prefab = "book_gardening",name = "应用园艺学",value = 0.18 },
{prefab = "trinket_26",name = "薯杯",value = 0.02 },
{prefab = "chester_eyebone",name = "眼骨",value = 0.30 },
{prefab = "armorskeleton",name = "白骨盔甲",value = 0.80 },
{prefab = "guano",name = "鸟粪",value = 0.03 },
{prefab = "petals",name = "花瓣",value = 0.015 },
{prefab = "panflute",name = "排箫",value = 0.30 },
{prefab = "hutch_fishbowl",name = "星空",value = 0.30 },
{prefab = "diviningrod",name = "探测杖",value = 0.20 },
{prefab = "gears",name = "齿轮",value = 0.04 },
{prefab = "nightmare_timepiece",name = "图勒奖章",value = 0.10 },	
{prefab = "royal_jelly",name = "蜂王浆",value = 0.40 },
{prefab = "rottenegg",name = "腐烂的蛋",value = 0.010 },
{prefab = "blue_mushroomhat",name = "蓝色乐趣帽子蘑菇",value = 0.12 },
{prefab = "fence_gate_item",name = "木制大门",value = 0.03 },
{prefab = "berries",name = "浆果",value = 0.01 },
{prefab = "horn",name = "野牛角",value = 0.10 },
{prefab = "red_cap_cooked",name = "烤小红帽蘑菇",value = 0.025 },
{prefab = "birdtrap",name = "捕鸟陷阱",value = 0.06 },
{prefab = "hammer",name = "锤子",value = 0.06 },
{prefab = "batbat",name = "蝙蝠棒",value = 0.18 },
{prefab = "phlegm",name = "脓鼻涕",value = 0.02 },
{prefab = "trinket_20",name = "长柄扒",value = 0.02 },
{prefab = "chesspiece_muse",name = "王后模型",value = 0.02 },
{prefab = "wetgoop",name = "失败料理",value = 0.01 },
{prefab = "lighter",name = "薇洛的打火机",value = 0.08 },
--{prefab = "cutreeds",name = "采下的芦苇",value = 0.015 },
{prefab = "meat_dried",name = "晒肉干",value = 0.035 },
{prefab = "corn",name = "玉米",value = 0.02 },
{prefab = "twigs",name = "树枝",value = 0.009 },
{prefab = "rocks",name = "石头",value = 0.009 },
{prefab = "mosquito",name = "蚊子",value = 0.08 },
{prefab = "glommerfuel",name = "咕嚕咪的黏液",value = 0.08 },
{prefab = "fish_cooked",name = "烤鱼",value = 0.04 },
{prefab = "flowerhat",name = "花环",value = 0.06 },
...
{prefab = "townportaltalisman",name = "砂石",value = 0.04 },
{prefab = "fish",name = "鱼",value = 0.04 },
{prefab = "axe",name = "斧头",value = 0.05 },
{prefab = "chesspiece_pipe",name = "泡沫管雕刻",value = 0.02 },
{prefab = "eel",name = "鳗鱼",value = 0.05 },
{prefab = "dragonbodyhat",name = "幸运野兽身体",value = 0.20 },
{prefab = "giftwrap",name = "礼物包装纸",value = 0.02 },
{prefab = "chesspiece_knight",name = "骑士模型",value = 0.02 },
{prefab = "marblebean",name = "大理石豆子",value = 0.06 },	
{prefab = "pumpkincookie",name = "南瓜饼",value = 0.06 },
{prefab = "cookedmandrake",name = "烤曼德拉草",value = 0.20 },
{prefab = "mandrake",name = "曼德拉草",value = 0.15 },
{prefab = "featherhat",name = "羽毛帽",value = 0.06 },
{prefab = "orangemooneye",name = "橙色月石",value = 0.30 },
{prefab = "trinket_10",name = "二手假牙",value = 0.02 },
{prefab = "log",name = "木头",value = 0.01 },
{prefab = "livinglog",name = "活木",value = 0.08 },
{prefab = "lifeinjector",name = "强心针",value = 0.06 },
{prefab = "coontail",name = "浣熊猫尾巴",value = 0.03 },
{prefab = "killerbee",name = "杀人蜂",value = 0.06 },
{prefab = "wathgrithrhat",name = "战斗头盔",value = 0.08 },
{prefab = "turf_marsh",name = "沼泽地皮",value = 0.01 },
{prefab = "bedroll_furry",name = "毛皮铺盖",value = 0.06 },
{prefab = "blowdart_fire",name = "火焰吹箭",value = 0.03 },
{prefab = "marble",name = "大理石",value = 0.03 },
{prefab = "goldnugget",name = "金块",value = 0.012 },
{prefab = "bundlewrap",name = "捆绑包装纸",value = 0.04 },
{prefab = "backpack",name = "背包",value = 0.06 },
{prefab = "hawaiianshirt",name = "花衬衫",value = 0.08 },
{prefab = "footballhat",name = "橄榄球头盔",value = 0.06 },
{prefab = "eggplant_cooked",name = "烤茄子",value = 0.02 },
{prefab = "ash",name = "灰烬",value = 0.01 },
{prefab = "strawhat",name = "草帽",value = 0.04 },
{prefab = "halloweencandy_4",name = "黏黏的蜘蛛",value = 0.01 },
{prefab = "klaussackkey",name = "牡鹿角",value = 0.50 },
{prefab = "honeycomb",name = "蜂窝",value = 0.10 },
{prefab = "spore_small",name = "绿色孢子",value = 0.02 },
{prefab = "trinket_1",name = "熔化的弹珠",value = 0.02 },
{prefab = "trinket_19",name = "不平衡陀螺",value = 0.02 },
{prefab = "slurper",name = "啜食者皮",value = 0.20 },
{prefab = "trap_teeth",name = "犬牙陷阱",value = 0.06 },
{prefab = "greengem",name = "绿色宝石",value = 0.40 },
{prefab = "bluegem",name = "蓝色宝石",value = 0.25 },
{prefab = "mapscroll",name = "地图卷轴",value = 0.18 },
{prefab = "furtuft",name = "毛皮丛",value = 0.015 },
{prefab = "goldenshovel",name = "黄金铲子",value = 0.06 },
{prefab = "trap",name = "陷阱",value = 0.06 },
{prefab = "blue_cap_cooked",name = "烤蓝帽子蘑菇",value = 0.025 },
{prefab = "armorwood",name = "木甲",value = 0.06 },
{prefab = "turf_cave",name = "鸟粪地皮",value = 0.01 },
{prefab = "cane",name = "步行手杖",value = 0.30 },
{prefab = "dug_berrybush2",name = "浆果丛",value = 0.02 },	
{prefab = "deer_antler1",name = "鹿角钥匙",value = 0.05 },
{prefab = "deer_antler2",name = "鹿角钥匙",value = 0.05 },
{prefab = "deer_antler3",name = "鹿角钥匙",value = 0.05 },	
...
{prefab = "winter_ornament_plain1",name = "普通圣诞装饰",value = 0.05 },
{prefab = "winter_ornament_plain2",name = "普通圣诞装饰",value = 0.05 },
{prefab = "winter_ornament_plain3",name = "普通圣诞装饰",value = 0.05 },	
{prefab = "winter_ornament_plain4",name = "普通圣诞装饰",value = 0.05 },
{prefab = "winter_ornament_plain5",name = "普通圣诞装饰",value = 0.05 },
{prefab = "winter_ornament_plain6",name = "普通圣诞装饰",value = 0.05 },
{prefab = "winter_ornament_plain7",name = "普通圣诞装饰",value = 0.05 },
{prefab = "winter_ornament_plain8",name = "普通圣诞装饰",value = 0.05 },	
{prefab = "winter_ornament_fancy1",name = "华丽圣诞装饰",value = 0.07 },
{prefab = "winter_ornament_fancy2",name = "华丽圣诞装饰",value = 0.07 },
{prefab = "winter_ornament_fancy3",name = "华丽圣诞装饰",value = 0.07 },
{prefab = "winter_ornament_fancy4",name = "华丽圣诞装饰",value = 0.07 },
{prefab = "winter_ornament_light1",name = "圣诞彩灯",value = 0.15 },
{prefab = "winter_ornament_light2",name = "圣诞彩灯",value = 0.15 },
{prefab = "winter_ornament_light3",name = "圣诞彩灯",value = 0.15 },
{prefab = "winter_ornament_light4",name = "圣诞彩灯",value = 0.15 },	
}
...
local addmoney = num * _item.value * shop.buy_multi * multiplier
...
if addmoney + shop.buyrecord[giver.userid] > 10 then
	addmoney = 10 - shop.buyrecord[giver.userid]
...
if shop.shopodd >= 1 then
	for i = 1,math.floor(shop.shopodd) do
		local redpouch = SpawnPrefab("redpouch")
...
local function ongivenitem(inst, giver, item)--给予浆果丛 暂不添加解锁科技功能(商店10级开启) 添加交易功能
	...
	if inst.lr_exp == nil then
		...
		inst.buy_multi = math.random(75,115)/100--初始化收购倍率
		inst.shopodd = 0--初始化商店零钱
		if giver.components.talker then
			giver.components.talker:Say("我想这个神奇的东西将会给我们带来一些意想不到的东西!")
		end
	else
		if item.prefab == "mandrakesoup" then--给予曼德拉汤刷新商店库存
			...
			inst.buy_multi = math.random(75,115)/100
			if giver.components.talker then
...
local function abletoaccepttest(inst, item, giver)
	...
	if item.prefab == "lucky_goldnugget" then
		if inst.sellrecord[giver.userid] and inst.sellrecord[giver.userid] >= 3 then
			if giver.components.talker then
	...
	if item.prefab ~= "mandrakesoup" and item.prefab ~= "dragonpie" then
		if inst.buyrecord[giver.userid] and inst.buyrecord[giver.userid] >= 8 then
			if giver.components.talker then
				giver.components.talker:Say("已达到出售上限!")
			end
			return false
	...
	if inst.lr_exp == nil then
		if item.prefab == "dug_berrybush" or item.prefab == "dug_berrybush2" or item.prefab == "dug_berrybush_juicy" then
			...
			if giver.components.talker then
				giver.components.talker:Say("得先激活这个神奇的东西")
			end
			return false
		end
	else
		if #inst.shoplist == 0 then
			if item.prefab == "lucky_goldnugget" or item.prefab == "dragonpie" then
				if giver.components.talker then
					giver.components.talker:Say("看起来这里的东西都已经卖光了!")
				end
				return false
			end
		end
...
--自动刷新商店列表
	inst:WatchWorldState("startday", function(inst)
		if math.random() < 0.25 and inst.lr_level then
			inst.shoplist = getselllist(selllist,inst.lr_level)
			inst.solditem = GetRandomItem(inst.shoplist)
			inst.buy_multi = math.random(75,125)/100
		end
	end)
